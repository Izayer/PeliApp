...
#crear actores
=begin
a1 = Actor.create(first_name: "Travis", last_name: "Fimmel", image: "http://es.web.img3.acsta.net/cx_160_213/b_1_d6d6d6/pictures/14/12/10/16/20/443482.jpg", bio: "Travis Fimmel (nacido en Lockington, Victoria, el 15 de julio de 1979) es un modelo y actor de cine y televisión australiano.1

Saltó a la fama en 2002, por ser la imagen de la campaña de modelaje de ropa interior para Calvin Klein2 Y atrajo la atención de la industria cinematográfica internacional al interpretar el papel protagonista de la serie Vikings (2013), interpretando al rey nórdico, legendario del siglo IX, Ragnar Lodbrok. También destacan sus intervenciones en la serie Tarzan (2003) y The Beast (2009)3 así como en la película Warcraft: El Origen (2016).")

a2 = Actor.create(first_name: "Toby", last_name: "Kebbell", image: "http://es.web.img2.acsta.net/cx_160_213/b_1_d6d6d6/pictures/15/07/22/14/49/241177.jpg", bio: "Tobias Alistair P. 'Toby' Kebbell, es un actor inglés mejor conocido por su trabajo en las películas Prince of Persia: The Sands of Time, donde dio vida a Garsiv, y en The Sorcerer's Apprentice, donde interpretó a Drake Stone." )

a3 = Actor.create(first_name: "Paula", last_name:"Patton", image:"http://es.web.img2.acsta.net/cx_160_213/b_1_d6d6d6/pictures/15/10/06/09/51/476987.jpg", bio:"Paula Maxine Patton (n. 5 de diciembre de 1975), más conocida como Paula Patton, es una actriz estadounidense, reconocida por su trabajo en las películas Dejá vu, Misión: Imposible - Protocolo Fantasma y Jumping the Broom.")

#crear pelicula
m1 = Movie.create(title: "WARCRAFT: EL ORIGEN", image: "https://www.google.es/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwi84_nygePMAhXFiRoKHYmYDakQjRwIBw&url=http%3A%2F%2Fwww.lashorasperdidas.com%2Findex.php%2F2015%2F11%2F06%2Ftrailer-de-warcraft-el-origen%2F&psig=AFQjCNGwfBD3exXi-rKAdyfd_e_LsS2euQ&ust=1463639961985593", release_year: "2016", plot: "La película nos traslada a un mundo de fantasía, donde habitan especies distintas como humanos, orcos o enanos, lleno de magia, de hechizos, de aventuras y de acción más allá de todo lo imaginable. Una espectacular historia de proporciones épicas, sobre el poder y las distintas facetas de la guerra, con combates y batallas que definirán el futuro de la humanidad de una manera totalmente impactante. En las dos caras del conflicto están, de un lado los humanos, liderados por la Alianza, y del otro, los orcos, con un sanguinario ejército conocido como la Horda.")

#asignar los actores a la pelicula
